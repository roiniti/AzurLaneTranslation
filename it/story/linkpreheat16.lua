FMLTranslator.loaded["LINKPREHEAT16"] = {
	fadeOut = 1.5,
	mode = 2,
	fadeType = 2,
	once = true,
	...
	scripts = {
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Inoltre, a causa delle forti interferenze delle onde radio, la comunicazione è impossibile... per non parlare della ricerca di {namecode:98}, anche Minato City non può essere contattata.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
