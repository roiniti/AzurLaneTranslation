FMLTranslator.loaded["WEICENGHUNHE14"] = {
	...
	scripts = {
		...
		},
		{
			...
			dir = 1,
			actor = 107110,
			say = "Quella ragazza non riesce proprio a stare ferma...",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Il fatto che ci sia un nuovo modello prodotto in serie significa che probabilmente ci stiamo avvicinando alla loro base.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Bingo! Sembra che tu abbia ragione~",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Bene. Andiamo a salvare Cooper, a sconfiggere le Sirene e a sollevare questa nebbia.",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
