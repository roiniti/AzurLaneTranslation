	...
	scripts = {
		{
			...
			nameColor = "#a9f548",
			dir = 1,
			say = "Nave de reparo Vestal, ao seu dispor! Você gostaria de alguns reparos~?",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
		...
		},
		{
			side = 2,
			dir = 1,
			say = "A Vestal está se oferecendo para restaurar nossas frotas às condições perfeitas.%。",
			typewriter = {
				speed = 0.05,
				speedUp = 0.01
			},
